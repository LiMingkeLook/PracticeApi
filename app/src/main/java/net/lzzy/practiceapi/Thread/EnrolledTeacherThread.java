...
public abstract class EnrolledTeacherThread<T> extends AsyncTask<Integer,Integer, String> {
    private final WeakReference<T> context;
    private String teacherJson="";
    private String ip="127.0.0.1:8080";
    protected EnrolledTeacherThread(T context, String ip, String teacherJson) {
    ...
    protected String doInBackground(Integer... integers) {
        try {
            return ApiService.okRequest("http://"+ip+"/Practice/api/registerOfTeacher"
                    ,KeyUtils.encryptionJson(teacherJson));
        } catch (Exception e) {
            e.printStackTrace();
