...
import net.lzzy.practiceapi.utils.DateTimeUtils;
...
public class UserCookies {
    ...
    public void changeOptionState(SOption option, boolean isChecked, boolean isMulti) {
    ...
    public boolean isOptionSelected(SOption option) {
        String ids = spOption.getString(option.getQuestionId().toString(), "");
    ...
    private Pair<Boolean,WrongType> isUserRight(String checkedIds, SQuestion question) {
        boolean miss = false, extra = false;
        for (SOption option : question.getOptions()) {
